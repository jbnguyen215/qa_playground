import {
  ...
  /*
The automation executed tests against the application handling changes as it should.
  1. Editing without saving was handled correctly.
  2. Editing and cancelling was handled correctly.
  3. Editing and saving was NOT handled correctly, further testing is required.
  4. Trying to save an invalid input presents an error.
  5. Trying to save an invalid input presents an error, and the change can then be cancelled correctly.
Out of the five tests executed, only one failed, so we need to do manual testing around saving valid changes.
*/